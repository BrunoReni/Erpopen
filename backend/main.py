...
from app.routes import auth, compras, financeiro, materiais, vendas, cotacoes, locais, faturamento, dev_tools, dashboard
...
def root():
    return {
        ...
        "version": "1.0.0",
        "modules": ["auth", "compras", "cotacoes", "financeiro", "materiais", "locais", "vendas", "faturamento", "dashboard", "dev"],
        "docs": "/docs"
    }
