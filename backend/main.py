...
from app.routes import auth, compras, financeiro, materiais, vendas, cotacoes, locais, faturamento, dev_tools
...
def root():
    return {
        ...
        "version": "1.0.0",
        "modules": ["auth", "compras", "cotacoes", "financeiro", "materiais", "locais", "vendas", "faturamento", "dev"],
        "docs": "/docs"
    }
